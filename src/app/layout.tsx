...
export const metadata: Metadata = {
  title: "The Studio Door - Creative Digital Solutions",
  description: "Creative studio specializing in brand identity, web development, and digital strategy. We craft exceptional digital experiences that drive results.",
  keywords: "creative studio, brand identity, web development, digital strategy, content creation, design agency",
  openGraph: {
    title: "The Studio Door - Creative Digital Solutions",
    description: "Creative studio specializing in brand identity, web development, and digital strategy. We craft exceptional digital experiences that drive results.",
    siteName: "The Studio Door",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/8960464/pexels-photo-8960464.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "The Studio Door creative workspace"
      }
    ]
  },
  twitter: {
    ...
    title: "The Studio Door - Creative Digital Solutions",
    description: "Creative studio specializing in brand identity, web development, and digital strategy.",
    images: ["https://images.pexels.com/photos/8960464/pexels-photo-8960464.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
